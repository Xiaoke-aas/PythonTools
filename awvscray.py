...
username = 'admxxxxxx' #修改你的账号
password = 'xxxxxxxxx'          #修改你的密码
...
class Awvs():
    ...
    def addTarget(self,target_url):
        ...
        if len(ret) > 3:
            ...
            info2 = {"user_agent":"Mozilla/5.0 (compatible; Baiduspider/2.0;  http://www.baidu.com/search/spider.html)","proxy":{"enabled":True,"protocol":"http","address":"127.0.0.1","port":7777}}
